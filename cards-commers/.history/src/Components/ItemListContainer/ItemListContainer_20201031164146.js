...
const getList = () => {
    return new Promise( (res) => {
        ...
        res(
            products = [
                {key:0, image:'remera-nike.jpg', productName:'Remera',
                marca:'Nike',genero:'Masculino', style:'Running', calidad:'Algodon 100%', talle:'M',
                color: 'Negro/Blanco',sku:'700020125628001', precio:'$2.500', cuotas:''},
                {id:1, image:'remera-adidas.jpg', productName:'Remera',
                marca:'Nike',genero:'Femenino', style:'Running', calidad:'Polyester 100%', talle:'L',
                color: 'Negro/Blanco',sku:'700020125628002', precio:'$2.500', cuotas:''},
                {id:2, image:'remera-puma.jpg', productName:'Remera',
                marca:'Nike',genero:'Femenino', style:'Running', calidad:'Algodon 100%', talle:'XS',
                color: 'Negro/Blanco',sku:'700020125628003', precio:'$2.500', cuotas:''},
                {id:3, image:'remera-under.jpg', productName:'Remera',
                ...
                {id:4, image:'remera-topper.jpg', productName:'Remera',
                ...
                {id:5, image:'remera-allstar.jpg', productName:'Remera',
