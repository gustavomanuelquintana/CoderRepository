    ...
    return new Promise( (res) => {
        ...
        res(
            products = [
                ...
                marca:'Nike', style:'Running', calidad:'Polyester 100%', talle:'L',
                color: 'Negro/Blanco', precio:'$2500'},
                {id:0, image:'../../Images/remera-puma.png', productName:'Remera',
                marca:'Nike', style:'Running', calidad:'Algodon 100%', talle:'XS',
                color: 'Negro/Blanco', precio:'$2500'},
                {id:0, image:'../../Images/remera-lacoste.png', productName:'Remera',
                marca:'Nike', style:'Running', calidad:'Polyester 100%%', talle:'XL',
                color: 'Negro/Blanco', precio:'$2500'},
                {id:0, image:'../../Images/remera-tommy.png', productName:'Remera',
                marca:'Nike', style:'Running', calidad:'Algodon 100%', talle:'XXL',
                color: 'Negro/Blanco', precio:'$2500'},
                {id:0, image:'../../Images/remera-allstar.png', productName:'Remera',
                marca:'Nike', style:'Running', calidad:'Algodon 100%', talle:'S',
                color: 'Negro/Blanco', precio:'$2500'}
            ]
        )
    });
