...
function ItemDetail({item:{id,image,producName,calidad,color,talle,genero,style,sku,precio}}){
  console.log(id);
    ...
    <Row key={item.id} className="ItemDetail">
      ...
      <div className="containerSectionDetail">
              <div className="infoDetail">
                    <p className="details"> <span className="infoMainDetail"> {productName}  {item.color}</span> </p>
