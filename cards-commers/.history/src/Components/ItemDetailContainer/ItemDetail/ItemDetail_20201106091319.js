    ...
    <Row key={item.id} className="ItemDetail">
      ...
      <Col sm="4">
        <div class="detail-section">
          <p class="fontDetail">La remera NIKE Hybrid aporta comodidad a tu día a día.Está confeccionada en tejido de algodón suave con una silueta clásica y un llamativo estampado.</p>
