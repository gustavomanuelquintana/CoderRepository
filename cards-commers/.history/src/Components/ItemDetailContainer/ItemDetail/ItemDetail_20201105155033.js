      ...
      <Col sm="4">
        <div class="detail-section">
          <ul class="itemsDetail">
            <li>La remera NIKE Hybrid aporta comodidad a tu día a día.</li>
            <li>Está confeccionada en tejido de algodón suave con una silueta clásica y un llamativo estampado</li>
            <li>Corte estandar</li>
