...
function ItemDetail({items}){
 ...
 return (items.map( productsDetail => {
    ...
    <Row className="Item">
      ...
      <div className="containerSection">
              <div className="info">
                    <p className="details"> <span>Producto:</span> {productsDetail.productName}  {listProducts.color} </p>
                    ...
                    <p className="details"> <span>Calidad / Talle:</span> {productsDetail.calidad} - {listProducts.talle}</p>
              </div>
          </div>
      </Col>
      <Col sm="4">
