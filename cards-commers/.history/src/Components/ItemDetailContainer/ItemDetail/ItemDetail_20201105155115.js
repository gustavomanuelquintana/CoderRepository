      ...
      <Col sm="4">
        <div class="detail-section">
          <ul class="itemsDetail">
            <li class="font-detail">La remera NIKE Hybrid aporta comodidad a tu día a día.</li>
            <li class="font-detail">Está confeccionada en tejido de algodón suave con una silueta clásica y un llamativo estampado</li>
            <li class="font-detail">Corte estandar</li>
            <li class="font-detail">Logo NIKE estampado.</li>
            </ul>
        </div>
        </Col>
        <Col sm="4">
