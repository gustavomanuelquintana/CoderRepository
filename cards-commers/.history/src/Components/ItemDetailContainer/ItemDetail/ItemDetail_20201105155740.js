    ...
    <Row key={item.id} className="ItemDetail">
      ...
      <Col sm="4">
        <div class="detail-section">
          <p class="fontDetail">La remera NIKE Hybrid aporta comodidad a tu día a día.</p>
          <p class="fontDetail">Está confeccionada en tejido de algodón suave con una silueta clásica y un llamativo estampado.</p>
          <p class="fontDetail">Corte estandar.</p>
          <p class="fontDetail">Logo NIKE estampado.</p>
        </div>
        </Col>
        <Col sm="4">
        <div class="shipping">
...
<p class="shipping-p">Envío Gratis a todo el país</p>
        </div>
        </Col>
        <Col sm="4">
        <div class="detail-section">
