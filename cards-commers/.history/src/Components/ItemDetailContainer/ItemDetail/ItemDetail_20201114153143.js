...
function ItemDetail(item){
    ...
    const handleBuy = (counter,itemcart) => {
      setCompra({isValid: true, id:itemcart.item.id,cantidad:counter, itemcart:itemcart})
      console.log("Probando al momento de enviarlo al itemProduct:" + compra.cantidad);
    }
