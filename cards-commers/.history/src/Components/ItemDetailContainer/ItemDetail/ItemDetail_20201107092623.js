...
function ItemDetail({item:{id,image,productName,marca,genero,style,calidad,talle,sku,precio,talle,color,sku,precio,detail1,detail2,detail3,detail4}}){
    ...
    <Row key={id} className="ItemDetail">
      ...
      <div className="containerSectionDetail">
              <div className="infoDetail">
                    <p className="details"> <span className="infoMainDetail"> {productName}  {item.item[0].color}</span> </p>
