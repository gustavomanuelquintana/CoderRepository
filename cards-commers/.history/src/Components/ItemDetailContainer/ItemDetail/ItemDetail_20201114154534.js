    ...
    const handleAdd = (counter) => {
      return ({stock}) => {
        if (stock <=0){
         ...
         handleBuy(counter,itemcart);
        }
      }
    }
      //Function button Buy
    const handleBuy = (counter,itemcart) => {
      Object.values(itemcart).map(e => console.log("probando map en objetoio: " + e));
      setCompra({isValid: true,cantidad:counter,itemcart})
      console.log("Probando al momento de enviarlo al itemProduct:" + compra.itemcart );
    }
