...
function ItemDetail(item){
    ...
    const handleBuy = (counter,itemcart) => {
      const test1 = itemcart.find(unidad => unidad.id ===itemcart.id);
      console.log(test1);
      setCompra({isValid: true,cantidad:counter})
      console.log("Probando al momento de enviarlo al itemProduct:" + compra.itemcart.id);
    }
