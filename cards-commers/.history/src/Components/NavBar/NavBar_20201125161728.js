...
function NavBar() {
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Nav.Link className="navLinks" style={{color: 'white'}} href="/">home <HousePage width={"20px"}/></Nav.Link>
      <Nav.Link className="navLinks" style={{color: 'white'}}>Promociones</Nav.Link>
