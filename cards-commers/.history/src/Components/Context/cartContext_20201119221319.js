...
export const sumItems = cartItems => {
    let suma = 0;
    let itemCount = cartItems.forEach(item => suma += cartItems.cantidad )
    let total = cartItems.reduce((total, product) => total + product.item.precio * product.cantidad, 0).toFixed(2);
