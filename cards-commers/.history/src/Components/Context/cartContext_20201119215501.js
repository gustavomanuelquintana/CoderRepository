...
export const sumItems = cartItems => {
    let total1 = 0;
    let itemCount = cartItems.item.reduce((total1, product) => total1 + product.cantidad, 0);
    let total = cartItems.item.reduce((total1, product) => total1 + product.item.precio * product.cantidad, 0).toFixed(2);
