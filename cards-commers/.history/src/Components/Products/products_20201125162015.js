...
export const productoItems = [
  ...
  },
  {
    ...
    precio: 2999,
    detail1:
      "Las gorras GOORIN BROS son únicas, su diseño moderno y urbano es lo que buscás para elevar tu estilo.",
  ...
  },
  {
    ...
    precio: 3100,
    detail1:
      "Esta remera de running TKO para mujer ADIDAS combina el poder de absorción de la tecnología Climalite con la protección contra los rayos UV para ayudar a cuidarte de los efectos dañinos del sol.",
    detail2:
      "Su confección de dos capas incorpora una remera exterior y una remera interior sin mangas, ambas con dobladillos curvos.",
  ...
  },
  {
    ...
    precio: 3000,
    detail1:
      "Hay remeras y remeras, pero esta remera tiene todo lo que necesitás para tus entrenamientos, confort y estilo.",
    detail2:
      "Confeccionada en materiales realmente funcionales como DryCell creada para alejar el sudor de tu piel, esta te mantendrá seca y cómoda, da igual al nivel al que te entregues.",
    detail3:
      "El logo reflectante y otros detalles te garantizarán no pasar desapercibido, el estilo sin duda será el centro de las miradas.",
  ...
  },
  {
    ...
    precio: 1649,
    detail1:
      "Con un diseño único la gorra Camo de Adidas es ideal para tus paseos por la ciudad.",
  ...
  },
  {
    ...
    precio: 2100,
    detail1:
      "Tus entrenamientos requieren que tus prendas acompañen tu rendimiento.",
    detail2: "Esta remera Topper está diseñada con tecnología Dry Cool.",
    detail3:
      "Un sistema que evapora la humedad de la prenda para mantenerte seco y cómodo.",
  ...
  },
  {
    ...
    precio: 2350,
    detail1:
      "La remera Tech 2.0 de Under Armour para entrenamiento incorpora un ajuste aerodinámico que acompaña tus movimientos sin distracciones.",
    detail2:
      "Tecnología antiolor que previene el crecimiento de microbios que causan mal olor.",
    detail3:
      "Posee tecnología Heatgear es un tejido súper transpirable que absorbe el sudor y regula la temperatura del cuerpo para que te sientas más fresco, seco y ligero que nunca.",
  ...
  },
  {
    ...
    precio: 4700,
    detail1:
      "Con un diseño original, este buzo es ideal para acompañarte en tus actividades urbanas.",
  ...
  },
  {
    ...
    detail2:
      "El ajuste regular logra un equilibrio cómodo entre holgado y ajustado.",
  ...
  },
  {
    ...
    talle: "-",
    color: "Blanco",
    sku: "7000201256280011",
    precio: 1800,
    detail1: "La carcasa suave y duradera tiene una sensación uniforme.",
    detail2:
      "Los gráficos de alto contraste facilitan el seguimiento de la pelota.",
    detail3: "Tamaño Nº5.",
    detail4:
      "IMPORTANTE: El balón debe ser inflado con la presión que indica en el panel cercano a la válvula.",
  },
];
