...
const Cart = () => {
    ...
    return (
        <div className="row no-gutters py-2">
            <div className="col-sm-2 p-2">
                <img src={products.item.item.image} alt="image" style={{margin: "0 auto", maxHeight: "50px"}} className="img-fluid d-block"
           />
            </div>
    ...
    <p className="mb-0">Cantidad: {products.cantidad}</p>
            </div>
