            ...
            cart.length > 0 &&
             <div className="col-sm-8 divTest">
               <div className="col-sm-6 totalItem">
                 <h6>Total Items</h6>
        <p className=" typeSize">{cartCount}</p>
               </div>
        ...
        <p className=" typeSize">${total}</p>
               ...
               <div className="col-sm-12">
                 <Row>
                   ...
                   <Col sm="6"><button onClick={clearItems} className="btn btn-default">Clear</button></Col>
               </Row>
               </div>
             </div>
             }
