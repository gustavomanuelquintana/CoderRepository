...
import ModalOrder from './modalOrder/modallOrder';
...
const Cart = () => {
    ...
    const [order, setOrder] = useState({name:'', email: '', adress: '', showCheckout: false, showProcessOrder:false});
        ...
        <p className=" typeSize">${total}</p>
               ...
               <div className="col-sm-12">
                 <Row>
                   <Col sm="6"><button
                    onClick={() => {
                      setOrder({ showProcessOrder: true });
                    }}
             ...
             {order.showProcessOrder && (
              ...
              {/*Fin Detail Cart -> Counter, Total and Button Continuar*/}
          </Col>
    </Row>
        </div>
      </>
