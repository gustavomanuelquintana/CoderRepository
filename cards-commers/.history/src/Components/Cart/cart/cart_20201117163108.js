...
useEffect(()=>{
    saveStatusCart(product,itemcart,setItemcart);
    ...
    return ( 
        <div className="row no-gutters py-2">
            <div className="col-sm-3 p-2">
                ...
                src={itemcart.item.image} className="img-fluid d-block"/>
            </div>
            <div className="col-sm-3 p-2 detailItem">
                <h5 className="mb-1">{itemcart.item.productName}</h5>
                <p className="mb-1">${itemcart.item.precio} </p>
                
            </div>
            <div className="col-sm-3 p-2 text-center detailItem ">
            <h5 className="mb-1">Cantidad</h5>
                 <p className="mb-0">{itemcart.cantidad}</p>
            </div>
